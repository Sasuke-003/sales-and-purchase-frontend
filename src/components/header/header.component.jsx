  ...
  const list = ( anchor, currentUser ) => (
    ...
    >
      ...
      <List>
        ...
        <ListItem button key={0} onClick={() => {history.push('/')}} >
...

        {
          currentUser && currentUser.Type === 'a' ?
            ...
            <ListItem button key={1} onClick={() => {history.push('/purchase')}} >
...

        {
          currentUser && currentUser.Type === 'a' ?
            ...
            <ListItem button key={2} onClick={() => {history.push('/stock')}} >
      ...
      <List>
...

        {
          currentUser && currentUser.Type === 'a' ?
            ...
            <ListItem button key={4} onClick={() => {history.push('/addseller')}} >
